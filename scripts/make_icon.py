"""Generate tools/icon.ico (a simple eye mark) using PIL. Run with a Python that has Pillow."""
from pathlib import Path

from PIL import Image, ImageDraw

ROOT = Path(__file__).resolve().parent.parent
ICON = ROOT / "tools" / "icon.ico"  # beside the build script that consumes it
SIZE = 256
